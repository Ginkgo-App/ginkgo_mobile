...
class UserFriendWidget extends StatelessWidget {
  ...
  const UserFriendWidget({Key key, this.user}) : super(key: key);
    ...
    return Skeleton(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            if (!isLoading && user.friendType == FriendType.accepted) ...[
            ...
            if (!isLoading && user.friendType == FriendType.requested)
              Container(
                decoration: BoxDecoration(
                  border: Border(
                    top: BorderSide(
